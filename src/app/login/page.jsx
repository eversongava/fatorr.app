        ...
        <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-6">
            <div className="max-w-md w-full">
                ...
                <div className="flex items-center justify-center gap-2 mb-12">
                    ...
                    <span className="text-2xl font-bold tracking-tight text-slate-900">Fator<span className="text-emerald-500 font-black">R</span></span>
                </div>

                {/* Card de Login */}
                <div className="bg-white rounded-[40px] shadow-2xl border border-slate-200 p-10 md:p-12 relative">
                    {/* Banner de Sucesso do Checkout */}
                    {checkoutSuccess && (
                        <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-max bg-emerald-500 text-white px-6 py-2 rounded-full font-black text-sm flex items-center gap-2 shadow-xl shadow-emerald-500/20 border-2 border-white animate-bounce-short">
                            <PartyPopper size={16} /> Pagamento validado!
                        </div>
                    )}
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">E-mail Profissional</label>
                        ...
                        >
                            {loading ? <Loader2 className="animate-spin" /> : 'Entrar via Magic Link'}
